...
<div class="events">
    <div class = "eventsmessage">
        ...
        <p>Although his messages are mainly for kids and seniors, he strives to reach<br>
            people of all ages! Check out what he has been up to on his Facebook
            timeline.
        </p>
        <button class="bookButton">
            <a href="contact.php" style="text-decoration:none; color: black;">
    ...
    <div class="timeline">
        ...
        <div class="fb-page" data-href="https://www.facebook.com/GOOFY-Grandad-304161619685945/"
             data-width=500px data-tabs="timeline" data-small-header="false" data-adapt-container-width="true"
             data-hide-cover="false" data-show-facepile="true"
             style="display: flex; justify-content: center; background-color: #ff66c6; padding-bottom: 3em;">
